...
Jesus-Chat是一个基于《西游记》剧本中猪Jesus的台词和语句，以及使用InternLM进行QLoRA微调得到的模仿猪Jesus语气的聊天语言模型。用户可以通过模型与Jesus-Chat进行对话。
...
![Jesus-Chat 截图](./assets/chat-demo.png)
...
本项目采用《西游记》剧本中关于猪Jesus的台词和语句作为训练数据，同时使用了InternLM进行QLoRA微调以生成更加贴合猪Jesus风格的语言。
...
[2024.2.14]：Jesus-Chat 权重公开至[ModelScope](https://www.modelscope.cn/models/JimmyMa99/BaJie-Chat/summary) 部署至 [OpenXLab](https://openxlab.org.cn/apps/detail/JimmyMa99/BaJie-Chat)

[2024.2.16]：Jesus-Chat 添加文言文和白话文数据，重新训练并部署
